...
export const DEFAULT_LOGISTICS_JOBS: LogisticsJob[] = [
  { id: 'railway', name: '修鐵路', icon: '🛤️', durationSeconds: 7200, rewards: { gems: 0, coins: 80, silver: 0, copper: 0, iron: 2, wood: 1 } },
  { id: 'paint', name: '刷油漆', icon: '🪣', durationSeconds: 7200, rewards: { gems: 0, coins: 60, silver: 1, copper: 1, iron: 0, wood: 0 } },
  { id: 'farm', name: '種田', icon: '🌾', durationSeconds: 7200, rewards: { gems: 0, coins: 50, silver: 0, copper: 0, iron: 0, wood: 2 } },
  { id: 'tree', name: '爬樹', icon: '🌳', durationSeconds: 7200, rewards: { gems: 0, coins: 45, silver: 0, copper: 0, iron: 0, wood: 3 } },
  { id: 'fish', name: '捕魚', icon: '🎣', durationSeconds: 7200, rewards: { gems: 1, coins: 70, silver: 0, copper: 1, iron: 0, wood: 0 } },
]
