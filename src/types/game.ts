...
export interface BattleLogEntry {
  type?: string
  html: string
  moveAnim?: { moveId: string; moveName: string; moveSlot: string; charName: string; charId?: string; attackerSide?: 'A' | 'B'; targetName?: string; targetCharId?: string; targetUnitId?: string; groupTargets?: Array<{ name: string; charId?: string }> }
}
